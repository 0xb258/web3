...
<template>
  <van-overlay z-index="99" :custom-style="{ backdropFilter: 'blur(5px)', background: 'rgba(0, 0, 0, 0.5)' }" :show="show">
    <div class="wrapper">
      <div class="card">
        ...
        <div class="card_footer">
          ...
          <div class="card_footer_btn" @click="handleConfirm">{{ props.confirmText || t('popup_confirm') }}</div>
        </div>
      </div>
    </div>
  </van-overlay>
